<?php
class Jbp_Giftlist_Block_Adminhtml_Ordercredito_Grid extends Mage_Adminhtml_Block_Widget_Grid{
    
    public function __construct()
    {
        parent::__construct();
        $this->setId('sales_order_grid_list_credito');
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->addAttributeToFilter('jbp_giftlist_resgate', array('eq' => 0));
    ...
    {
        return $this->getUrl('*/*/gridcredito', array('_current'=>true));
    }
